...
<div class="container-fluid">
    <div class="row mt-4 mx-auto position-relative">
        <a class="btn btn-primary align-right position-absolute top-100 start-50 translate-middle mt-1" href="{{ route('product.add.view') }}" type="button">Add product</a>
    </div>
    <div class="row">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-grid gap-2 col-6 mx-auto">
                                ...
                                <a href="{{ route('product.delete', $product->id) }}" class="btn btn-danger" type="button">Delete</a>
                            </div>
                        </td>
                    </tr>
                    @endforeach
