        ...
        <div class="row mb-3">
            <form action="{{ route('product.update', $productI->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" min="0" step="0.1" max="10000" oninput="validty.valid||(value='');"
                           class="form-control" name="price" id="price" aria-describedby="price1" value="{{ $productI->price }}" required>
